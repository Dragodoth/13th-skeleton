...
When you intercept an enemy that is moving to attack one of your allies, you gain a +3 bonus to all defences until the end of that turn (so against that enemy’s attacks).
