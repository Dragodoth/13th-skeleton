...
<div class="grid h-screen grid-rows-[auto_1fr_auto] overflow-auto">
        ...
        <svelte:fragment slot="trail">
            <label class="flex flex-col items-center">
                ...
                <RadioGroup
                    ...
                    padding="px-3 py-1">
                    <RadioItem bind:group={$use2E} name="1E" value={false}
                        >1E</RadioItem>
                    <RadioItem bind:group={$use2E} name="2E" value={true}
                        >2E</RadioItem>
                </RadioGroup>
            </label>
            <LightSwitch />
    ...
    <header class="p-2 {showNav ? 'flex lg:hidden' : 'hidden'}">
        <nav class="list-nav card p-2 w-full">
            <ul class="w-full">
                <li>
                    <a href="/about">
    ...
    <AppBar>
        ...
        <svelte:fragment slot="trail">stuff</svelte:fragment>
    </AppBar>
</div>
